// module ystrahinov/terraform-up-and-running
module /terraform-YS/08-Productiongrade-TF-code/small-modules/examples/networking/alb
...
require github.com/gruntwork-io/terratest v0.46.0
